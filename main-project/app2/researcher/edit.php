...
$statement = $conn->prepare("SELECT * FROM tester1.Admin, tester1.specialUser, tester1.Users WHERE Researcher.uID = specialUser.uID AND specialUser.uID = Users.uID AND Admin.adminID = :adminID");
