...
if (
    ...
    $article = $conn->prepare("INSERT INTO tester1.Article (authName,majTopic,minTopic,pubDate,artTitle,summary,uID) VALUES (:authName,:majTopic,:minTopic,:pubDate,:artTitle,:summary,:uID);");
