...
if (
 isset($_POST["uID"])
    ...
    $researcher = $conn->prepare("INSERT INTO tester1.Researcher (uID) VALUES (:uID);");
    ...
    $researcher->bindParam(':uID', $_POST["uID"]);

    if ($researcher->execute()) {
        header("Location: .");
    }
}
